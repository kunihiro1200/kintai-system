      ...
      >
        ...
        <div style={{ fontSize: '0.85rem', color: '#856404', lineHeight: '1.6' }}>
          <ol style={{ margin: 0, paddingLeft: '1.5rem' }}>
            ...
            <li style={{ marginBottom: '0.5rem' }}>遅刻をした場合、翌出勤日その時間分早く出勤することとする。翌出勤日来れなかった場合、２日分早朝出勤となる。（例：30分遅刻し、翌出勤日に9時に出勤すべきなのに9時10分等に出勤した場合、それはカウントされないので、翌出勤日と翌々出勤日は9時出勤となる。時間をきちんと測るため、出勤したら会社の固定電話から会社に留守電残すこととする。）</li>
          </ol>
