      ...
      >
        ...
        <div style={{ fontSize: '0.85rem', color: '#856404', lineHeight: '1.6' }}>
          <ol style={{ margin: 0, paddingLeft: '1.5rem' }}>
            ...
            <li style={{ marginBottom: '0.5rem' }}>台風、大雪、その他天候の影響の出勤は自己判断とします。天気は予報がでているのであらかじめ天候悪化が予測される時は前日にPCは持って帰ること。天候の影響でリモートワークに切り替える場合や有給休暇とする場合は、その旨９時までに会社の全員のLINEに通知すること。リモートワーク者はGoogleカレンダーに１時間ごとに何をしたかの入力をすること。また会社の電話はリモートワーク者で回すこととする。出勤できずPCも持ち帰っていない場合は有給休暇とみなす（有給休暇のある社員のみ）。当日の内覧や訪問等の約束事がある場合、その担当者はお客様に約束の1時間前までに電話で本日の件どうされるかを確認し、その内容を必ずGoogleカレンダーにその旨入力すること。</li>
          </ol>
