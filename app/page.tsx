      ...
      >
        ...
        <div style={{ fontSize: '0.85rem', color: '#856404', lineHeight: '1.6' }}>
          <ol style={{ margin: 0, paddingLeft: '1.5rem' }}>
            ...
            <li style={{ marginBottom: '0.5rem' }}>月曜が祝日の場合、事務所の清掃は月曜祝日出勤者が行うこと。（9時半出勤でよい）</li>
            ...
            <li style={{ marginBottom: '0.5rem' }}>台風、大雪、その他天候の影響の出勤は自己判断とします。天気は予報がでているのであらかじめ天候悪化が予測される時は前日にPCは持って帰ること。天候の影響でリモートワークに切り替える場合や有給休暇とする場合は、その旨９時までに会社の全員のLINEに通知すること。リモートワーク者はGoogleカレンダーに１時間ごとに何をしたかの入力をすること。また会社の電話はリモートワーク者で回すこととする。出勤できずPCも持ち帰っていない場合は有給休暇となります（有給休暇のある社員のみ）。当日の内覧や訪問等の約束事がある場合、その担当者はお客様に約束の1時間前までに電話で本日の件どうされるかを確認し、その内容を必ずGoogleカレンダーに入力すること。</li>
            <li style={{ marginBottom: '0.5rem' }}>無断欠勤は2回で解雇の対象となる</li>
            <li style={{ marginBottom: '0.5rem' }}>遅刻をした場合、翌出勤日その時間分早く出勤することとする。翌出勤日来れなかった場合、２日分早朝出勤となる。（例：30分遅刻し、翌出勤日に9時に出勤すべきなのに9時10分等に出勤した場合、それはカウントされないので、翌出勤日と翌々出勤日は9時出勤となる。時間をきちんと測るため、出勤したら会社の固定電話から会社に留守電を残すこととする。）</li>
            <li style={{ marginBottom: '0.5rem', fontWeight: 'bold', color: '#d9534f' }}>年末年始・お盆休みは特別休暇のため、個人休と重なった場合でも、代休の取得はできません。</li>
          </ol>
